...
private:
    ...
    TSharedPtr<FJsonObject> HandleSetBlueprintCategorySorting(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleBindPCGGenerationSettingsToBlueprint(const TSharedPtr<FJsonObject>& Params);
